...
class PlateDetector:
    ...
    def get_found_plates(self):
        return self.plate_like_objects

    def find_plate(self, filename):
        ...
        plate_dimensions = (
            0.03 * label_image.shape[0], 0.08 * label_image.shape[0], 0.15 * label_image.shape[1],
            0.3 * label_image.shape[1])
        plate_dimensions2 = (
            0.08 * label_image.shape[0], 0.2 * label_image.shape[0], 0.15 * label_image.shape[1],
